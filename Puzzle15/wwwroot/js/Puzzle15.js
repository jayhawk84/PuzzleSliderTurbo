...
var img = new Image();
img.onload = startImageSplit;
img.src = "https://github.com/jayhawk84/SuperPuzzleSliderTurbo/blob/master/PuzzleMedia/Color_Turtle.jpg";
*/
...
function updateBtns() {
    ...
    clickCounter.innerHTML = "Moves: " + clicks;
}
function shuffle() {
    var v = 0, t;
    do {
    ...
    for (var j = 0; j < 4; j++) {
        for (var i = 0; i < 4; i++) {
            ...
            /*ctx.drawImage(
                ...
                //draw it on canvas based on the buttons
                b.col * pieceWidth, p.row * pieceHeight, pieceWidth, pieceHeight);
            //b.appendChild(b);*/
        }
    }
